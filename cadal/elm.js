...
var _user$project$Main$authFromCredentials = function (encoded) {
	return A2(_elm_lang$core$Basics_ops['++'], 'Basic ', encoded);
};
var _user$project$Main$checkCredentials = F2(
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'SaveCredentials':
				return A2(_user$project$Main$checkCredentials, model.username, model.password) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							auth: _elm_lang$core$Maybe$Just(
								_user$project$Main$authFromCredentials(model.encoded)),
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							error: _elm_lang$core$Maybe$Just('Wrong credentials')
						}),
					{ctor: '[]'});
			case 'UsernameChange':
				var _p1 = _p0._0;
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {username: a, password: b, encoded: c, auth: d, error: e};
	});
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	A5(_user$project$Main$Model, '', '', '', _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing),
	{ctor: '[]'});
var _user$project$Main$EncodedAuth = function (a) {
	return {ctor: 'EncodedAuth', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$encoded(_user$project$Main$EncodedAuth);
};
var _user$project$Main$PasswordChange = function (a) {
	return {ctor: 'PasswordChange', _0: a};
};
var _user$project$Main$UsernameChange = function (a) {
	return {ctor: 'UsernameChange', _0: a};
};
var _user$project$Main$SaveCredentials = {ctor: 'SaveCredentials'};
var _user$project$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Main$SaveCredentials),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('id_username'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$UsernameChange),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"UsernameChange":["String"],"SaveCredentials":[],"PasswordChange":["String"],"EncodedAuth":["String"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
