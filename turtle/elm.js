...
var _user$project$Translation$codeToLanguage = function (languageCode) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Translation$English,
		A2(
			...
			_elm_lang$core$Dict$fromList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'en', _1: _user$project$Translation$English},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'fr', _1: _user$project$Translation$French},
						_1: {ctor: '[]'}
					}
				})));
};
...
var _user$project$Examples$elm = function (lang) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Translation$Left(90),
			_1: {
				ctor: '::',
				_0: _user$project$Translation$PenUp,
				_1: {
					ctor: '::',
					_0: _user$project$Translation$Forward(100),
					_1: {
						ctor: '::',
						_0: _user$project$Translation$PenDown,
						_1: {
							ctor: '::',
							_0: _user$project$Translation$Forward(50),
							_1: {
								ctor: '::',
								_0: _user$project$Translation$Right(90),
								_1: {
									ctor: '::',
									_0: _user$project$Translation$Forward(100),
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _user$project$Translation$Left(180),
												_1: {
													ctor: '::',
													_0: _user$project$Translation$Forward(50),
													_1: {
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _user$project$Translation$Forward(40),
																	_1: {
																		ctor: '::',
																		_0: _user$project$Translation$Left(180),
																		_1: {
																																		...
																																		_1: {
																																			...
																																			_1: {
																																				...
																																				_1: {
																																					...
																																					_1: {
																																						ctor: '::',
																																						_0: _user$project$Translation$Right(140),
																																						_1: {
																																							ctor: '::',
																																							_0: _user$project$Translation$Forward(60),
																																							_1: {
																																								ctor: '::',
																																								_0: _user$project$Translation$Left(100),
																																								_1: {
																																									ctor: '::',
																																									_0: _user$project$Translation$Forward(60),
																																									_1: {
...
var _user$project$Examples$star = function (lang) {
	return A2(
		...
		_user$project$Translation$translate(lang),
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Translation$Right(144),
				_1: {
					ctor: '::',
					_0: _user$project$Translation$Forward(100),
					_1: {
...
var _user$project$Examples$house = function (lang) {
	return A2(
		...
		_user$project$Translation$translate(lang),
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Translation$Right(135),
				_1: {
					ctor: '::',
					_0: _user$project$Translation$Forward(141.42),
					_1: {
						ctor: '::',
						_0: _user$project$Translation$Left(135),
						_1: {
							ctor: '::',
							_0: _user$project$Translation$Forward(100),
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _user$project$Translation$Forward(70.71),
											_1: {
												ctor: '::',
												_0: _user$project$Translation$Right(90),
												_1: {
			...
			while (true) {
				...
				if (_p5.ctor === '::') {
					...
					if (_p7.ctor === 'Nothing') {
						...
						paths = _v7;
						moves = _v8;
						continue movesToPaths_;
					} else {
						var _v9 = newPoint,
							_v10 = newAngle,
							_v11 = newDraw,
							_v12 = newDraw ? {ctor: '::', _0: _p7._0, _1: paths} : paths,
							_v13 = _p8;
						point = _v9;
						angle = _v10;
						draw = _v11;
...
var _user$project$Main$translateError = F2(
	function (lang, _p9) {
		...
		var _p12 = _p10.line;
		var _p11 = _p10.error;
		if (_p11.ctor === 'ParseCommandError') {
			return A2(
				_user$project$Translation$translate,
				lang,
				A2(_user$project$Translation$ParseCommandError, _p12, _p11._0));
		} else {
			return A2(
				_user$project$Translation$translate,
				lang,
				A2(_user$project$Translation$ParseFloatError, _p12, _p11._0));
		}
	});
...
var _user$project$Main$parseCommands = F2(
	function (commands, language) {
		var _p14 = commands;
		if (_p14.ctor === 'Just') {
			return A2(_elm_lang$core$String$split, '\n', _p14._0);
		} else {
			return _user$project$Examples$house(language);
		}
	});
var _user$project$Main$stringParamWithDefault = F2(
...
var _user$project$Main$queryParser = A2(
	_evancz$url_parser$UrlParser_ops['<?>'],
	A2(
		_evancz$url_parser$UrlParser_ops['<?>'],
		_evancz$url_parser$UrlParser$top,
		A2(_user$project$Main$stringParamWithDefault, 'lang', 'en')),
	_evancz$url_parser$UrlParser$stringParam('commands'));
var _user$project$Main$turtle = {
	ctor: '::',
	_0: 'Forward 10',
	_1: {
		ctor: '::',
		...
		function (errors, moves, movesAndErrors) {
			...
			while (true) {
				...
				if (_p15.ctor === '[]') {
					...
					if (_p16._1.ctor === 'Ok') {
						var _v20 = errors,
							_v21 = {ctor: '::', _0: _p16._1._0, _1: moves},
							_v22 = _p17;
						errors = _v20;
						moves = _v21;
						movesAndErrors = _v22;
						continue splitMovesFromErrors_;
					} else {
						var _v23 = {
							ctor: '::',
							_0: A2(_user$project$Main$ErrorMessage, _p16._0 + 1, _p16._1._0),
							_1: errors
						},
							_v24 = moves,
							_v25 = _p17;
...
var _user$project$Main$QueryData = F2(
	function (a, b) {
		return {lang: a, commands: b};
	});
var _user$project$Main$parseUrl = function (location) {
	var _p18 = A2(
		_elm_lang$core$Maybe$withDefault,
		{lang: 'en', commands: _elm_lang$core$Maybe$Nothing},
		A2(
			_evancz$url_parser$UrlParser$parseHash,
			A2(_evancz$url_parser$UrlParser$map, _user$project$Main$QueryData, _user$project$Main$queryParser),
			location));
	var lang = _p18.lang;
	var commands = _p18.commands;
	var language = _user$project$Translation$codeToLanguage(lang);
	return {
		ctor: '_Tuple2',
		_0: language,
		_1: A2(_user$project$Main$parseCommands, commands, language)
	};
};
var _user$project$Main$init = function (location) {
	var _p19 = _user$project$Main$parseUrl(location);
	var language = _p19._0;
	var commands = _p19._1;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		A3(_user$project$Main$Model, commands, true, language),
		{
			ctor: '::',
			_0: _elm_lang$navigation$Navigation$newUrl(
				A2(_user$project$Main$urlFromCommands, commands, language)),
			_1: {ctor: '[]'}
		});
};
			...
			case 'CommandsChange':
				return A2(
					...
					model,
					{
						...
						_0: _elm_lang$navigation$Navigation$newUrl(
							A2(
								_user$project$Main$urlFromCommands,
				...
				return A2(
					...
					model,
					{
						...
						_0: _elm_lang$navigation$Navigation$newUrl(
							A2(
								_user$project$Main$urlFromCommands,
								_user$project$Examples$house(model.lang),
								model.lang)),
						_1: {ctor: '[]'}
					});
			case 'LoadStar':
				return A2(
					...
					model,
					{
						...
						_0: _elm_lang$navigation$Navigation$newUrl(
							A2(
								_user$project$Main$urlFromCommands,
								_user$project$Examples$star(model.lang),
								model.lang)),
						_1: {ctor: '[]'}
					});
			case 'LoadElm':
				return A2(
					...
					model,
					{
						...
						_0: _elm_lang$navigation$Navigation$newUrl(
							A2(
								_user$project$Main$urlFromCommands,
								_user$project$Examples$elm(model.lang),
								model.lang)),
						_1: {ctor: '[]'}
					});
			case 'DrawTurtle':
			...
			case 'SetLanguage':
				return A2(
					...
					model,
					{
						ctor: '::',
						_0: _elm_lang$navigation$Navigation$newUrl(
							A2(_user$project$Main$urlFromCommands, model.commands, _p20._0)),
						_1: {ctor: '[]'}
					});
			default:
				var _p21 = _user$project$Main$parseUrl(_p20._0);
				var language = _p21._0;
				var commands = _p21._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{lang: language, commands: commands}),
					{ctor: '[]'});
		}
	});
...
var _user$project$Main$languageSwitcher = function (lang) {
	var isCurrent = function (lang_) {
		return _elm_lang$core$Native_Utils.eq(lang, lang_);
	};
	var button_ = F2(
		function (lang_, name) {
			return A2(
				_elm_lang$html$Html$button,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$SetLanguage(lang_)),
						_1: {ctor: '[]'}
					}
				},
				{
	...
	return A2(
		...
		{
			ctor: '::',
			_0: A2(button_, _user$project$Translation$English, 'English'),
			_1: {
				ctor: '::',
				_0: A2(button_, _user$project$Translation$French, 'Français'),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$stringToFloat = function (str) {
	var errorMessage = function (_p22) {
...
var _user$project$Main$Left = function (a) {
	return {ctor: 'Left', _0: a};
};
var _user$project$Main$Forward = function (a) {
	return {ctor: 'Forward', _0: a};
};
var _user$project$Main$parseCommand = function (command) {
	var _p23 = A2(_elm_lang$core$String$split, ' ', command);
	_v27_10:
	do {
		if (_p23.ctor === '::') {
			if (_p23._1.ctor === '::') {
					...
					switch (_p23._0) {
						case 'Forward':
							return A2(
								...
								_user$project$Main$stringToFloat(_p23._1._0));
						case 'Avance':
							return A2(
								_elm_lang$core$Result$map,
								_user$project$Main$Forward,
		...
		F2(
			function (i, command) {
				return {
					ctor: '_Tuple2',
					_0: i,
					_1: _user$project$Main$parseCommand(command)
				};
			}),
		commands);
};
var _user$project$Main$view = function (model) {
	...
	var _p24 = _user$project$Main$splitMovesFromErrors(parsed);
	var errors = _p24._0;
	var moves = _p24._1;
	return A2(
		_elm_lang$html$Html$div,
		...
		{
			ctor: '::',
			_0: _user$project$Main$languageSwitcher(model.lang),
			_1: {
				ctor: '::',
				_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$checked(model.drawTurtle),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onCheck(_user$project$Main$DrawTurtle),
													_1: {ctor: '[]'}
												}
											}
										},
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$textarea,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$CommandsChange),
									_1: {
										ctor: '::',
						...
						_1: {
							...
							_0: _evancz$elm_graphics$Element$toHtml(
								A3(
									...
									{
										ctor: '::',
										_0: _user$project$Main$drawShape(
											A2(_evancz$elm_graphics$Collage$rect, 600, 600)),
										_1: A2(
											_elm_lang$core$List$map,
											_user$project$Main$drawPath,
											_user$project$Main$movesToPaths(moves))
									})),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$LoadHouse),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$LoadStar),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$LoadElm),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
