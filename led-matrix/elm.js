...
var _user$project$Main$urlFromData = F3(
...
var _user$project$Main$intParamWithDefault = F2(
...
var _user$project$Main$queryParser = A2(
	...
	A2(
		...
		A2(
			...
			A2(_user$project$Main$intParamWithDefault, 'height', 8)),
		A2(_user$project$Main$intParamWithDefault, 'width', 8)),
	_evancz$url_parser$UrlParser$stringParam('data'));
...
var _user$project$Main$parseLines = F3(
	function (data, height, width) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			A2(_user$project$Main$loadEmpty, height, width),
			data);
	});
...
var _user$project$Main$QueryData = F3(
	function (a, b, c) {
		return {height: a, width: b, data: c};
	});
var _user$project$Main$parseUrl = function (location) {
	var _p2 = A2(
		_elm_lang$core$Maybe$withDefault,
		{width: 8, height: 8, data: _elm_lang$core$Maybe$Nothing},
		A2(
	...
	return {
		...
		_0: width,
		_1: height,
		_2: A3(_user$project$Main$parseLines, data, width, height)
	};
};
	...
	function (msg, model) {
		...
		switch (_p3.ctor) {
			case 'ToggleLed':
				var _p5 = _p3._0;
				var _p4 = _p3._1;
				var prevLedStatus = A3(_user$project$Main$getLedStatus, _p5, _p4, model);
				var newMatrix = A4(_user$project$Main$setLedStatus, _p5, _p4, !prevLedStatus, model);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
						...
						_0: _elm_lang$navigation$Navigation$newUrl(
							A3(
								_user$project$Main$urlFromData,
								model.matrixWidth,
								model.matrixHeight,
								_user$project$Main$matrixToText(newMatrix))),
						_1: {ctor: '[]'}
					});
			case 'UpdateMatrix':
				var _p6 = _p3._0;
				var newMatrix = _user$project$Main$textToMatrix(_p6);
					...
					model,
					{
						...
						_0: _elm_lang$navigation$Navigation$newUrl(
							A3(
								_user$project$Main$urlFromData,
								maxWidth,
								_elm_lang$core$Array$length(newMatrix),
								_p6)),
						_1: {ctor: '[]'}
					});
			case 'LoadA':
				...
				return A2(
					...
					model,
					{
						ctor: '::',
						_0: _elm_lang$navigation$Navigation$newUrl(
							A3(_user$project$Main$urlFromData, size, size, _user$project$Main$loadA)),
						_1: {ctor: '[]'}
					});
			case 'LoadSmiley':
				...
				return A2(
					...
					model,
					{
						ctor: '::',
						_0: _elm_lang$navigation$Navigation$newUrl(
							A3(_user$project$Main$urlFromData, size, size, _user$project$Main$loadSmiley)),
						_1: {ctor: '[]'}
					});
			case 'LoadEmpty':
				return A2(
			...
			case 'ChangeMatrixWidth':
				var _p7 = _elm_lang$core$String$toInt(_p3._0);
				if (_p7.ctor === 'Err') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
					...
					var _p8 = _p7._0;
					var height = model.enforceSquare ? _p8 : model.matrixHeight;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{
							...
							_0: _elm_lang$navigation$Navigation$newUrl(
								A3(
									...
									_p8,
									height,
									A2(_user$project$Main$loadEmpty, _p8, height))),
							_1: {ctor: '[]'}
						});
				}
			case 'ChangeMatrixHeight':
				var _p9 = _elm_lang$core$String$toInt(_p3._0);
				if (_p9.ctor === 'Err') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
					...
					var _p10 = _p9._0;
					var width = model.enforceSquare ? _p10 : model.matrixWidth;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{
							...
							_0: _elm_lang$navigation$Navigation$newUrl(
								A3(
									...
									width,
									_p10,
									A2(_user$project$Main$loadEmpty, width, _p10))),
							_1: {ctor: '[]'}
						});
				}
			case 'ChangeEnforceSquare':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{enforceSquare: _p3._0}),
					{ctor: '[]'});
			default:
				var _p11 = _user$project$Main$parseUrl(_p3._0);
				var width = _p11._0;
				var height = _p11._1;
				var data = _p11._2;
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							matrixWidth: width,
							matrixHeight: height,
							matrix: _user$project$Main$textToMatrix(data)
						}),
					{ctor: '[]'});
		}
	});
var _user$project$Main$init = function (location) {
	var _p12 = _user$project$Main$parseUrl(location);
	var width = _p12._0;
	var height = _p12._1;
	var data = _p12._2;
	return A2(
		...
		_user$project$Main$initialModel,
		{
			ctor: '::',
			_0: _elm_lang$navigation$Navigation$newUrl(
				A3(_user$project$Main$urlFromData, width, height, data)),
			_1: {ctor: '[]'}
		});
};
